...
//                .show();
        ...
        titleText = (TextView) dialog.findViewById(R.id.titleView);
        titleText.setText(R.string.about);
        helpText = (TextView) dialog.findViewById(R.id.helpText);
        ...
        Linkify.addLinks(helpText,Linkify.ALL);
        helpText.setLinkTextColor(Color.BLUE);
        helpText.setTypeface( Typeface.createFromAsset(callingActivity.getResources().getAssets(), "fonts/wt040.ttf"));
